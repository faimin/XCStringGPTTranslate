...
public extension StringVariations {
    struct DeviceKey: Codable, Hashable, RawRepresentable, ExpressibleByStringLiteral {
    ...
    struct PluralKey: Codable, Hashable, RawRepresentable, ExpressibleByStringLiteral {
        public let rawValue: String
